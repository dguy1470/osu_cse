...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
        ...
        //take the substring of str1 and subtract the overlap before adding str2
        String strComb = str1.substring(0, str1.length() - overlap) + str2;
        return strComb;
    ...
    public static void addToSetAvoidingSubstrings(Set<String> strSet,
        ...
        for (String s : strSet) {
            ...
            if (s.indexOf(str) != -1) {
                return;
                //if indexOf returns -1 then s does not appear in str at all and we are done
            }
        }
        strSet.add(str);
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        //while not at the end of string, read the next line and use it in the
        //addToSetAvoidingSubstrings method
        while (!input.atEOS()) {
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        //simply replace all "~" with "\n" to print a new line instead of ~'s
